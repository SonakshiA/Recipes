...
public class Recipe9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.consecutive_recipes);
        ...
        previousButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Recipe9.this, Recipe8.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Recipe9.this,Recipe10.class);
                startActivity(intent);
            }
        });
    }
    ...
    private class RecipeAsyncTask extends AsyncTask<URL, Void, RecipeClass>{
        ...
        private RecipeClass extractFromJson(String recipeJSON){
            try{
                ...
                JSONObject jsonObject = jsonArray.optJSONObject(8);
