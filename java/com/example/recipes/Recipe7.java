...
public class Recipe7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previousButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Recipe7.this, Recipe6.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Recipe7.this,Recipe8.class);
                startActivity(intent);
            }
        });
    }
    ...
    private class RecipeAsyncTask extends AsyncTask<URL, Void, RecipeClass>{
        ...
        private RecipeClass extractFromJson(String recipeJSON){
            try{
                ...
                JSONObject jsonObject = jsonArray.optJSONObject(6);
